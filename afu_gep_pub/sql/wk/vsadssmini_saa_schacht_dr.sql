...
INSERT INTO 
    ${DB_SCHEMA_PUB_STAGING}.saa_schacht_dr 
    (
        baujahr, 
        baulicherzustand, 
...
AND oid_dss NOT IN (SELECT oid_dss FROM ${DB_SCHEMA_PUB_STAGING}.saa_schacht_se)
AND oid_dss NOT IN (SELECT oid_dss FROM ${DB_SCHEMA_PUB_STAGING}.saa_sbw)
