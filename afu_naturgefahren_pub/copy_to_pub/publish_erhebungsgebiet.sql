SELECT 
    flaeche, 
    split_part(status_ueberschwemmung,',',1) AS status_ueberschwemmung,
    beurteilung_ueberschwemmung.dispname AS status_ueberschwemmung_txt, 
    split_part(status_uebermurung,',',1)  AS status_uebermurung,
    beurteilung_uebermurung.dispname AS status_uebermurung_txt, 
    split_part(status_ufererosion,',',1)  AS status_ufererosion,
    beurteilung_ufererosion.dispname AS status_ufererosion_txt, 
    split_part(status_permanente_rutschung,',',1)  AS status_permanente_rutschung,
    beurteilung_permanente_rutschung.dispname AS status_permanente_rutschung_txt, 
    split_part(status_spontane_rutschung,',',1)  AS status_spontane_rutschung,
    beurteilung_spontane_rutschung.dispname AS status_spontane_rutschung_txt, 
    split_part(status_hangmure,',',1)  AS status_hangmure,
    beurteilung_hangmure.dispname AS status_hangmure_txt, 
    split_part(status_stein_block_schlag,',',1)  AS status_stein_block_schlag,
    beurteilung_stein_block_schlag.dispname AS status_stein_block_schlag_txt, 
    split_part(status_fels_berg_sturz,',',1)  AS status_fels_berg_sturz,
    beurteilung_fels_bergs_sturz.dispname AS status_fels_berg_sturz_txt, 
    split_part(status_einsturz,',',1)  AS status_einsturz,
    beurteilung_einsturz.dispname AS status_einsturz_txt, 
    split_part(status_absenkung,',',1)  AS status_absenkung,
