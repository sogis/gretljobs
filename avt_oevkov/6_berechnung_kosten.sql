-- Tabelle avt_oevkov_2019.sachdaten_oevkov_daten
...
SET
    ...
    SELECT
        sum(einwohnerzahl)
     FROM
         avt_oevkov_2019.auswertung_gemeinde_einwohner_kosten                                                                                                                           
     )
;

-- Gewichtete Haltestellenabfahrten Total
UPDATE
     avt_oevkov_2019.sachdaten_oevkov_daten AS oevkov_daten
SET
...
FROM
    ...
    FROM
        avt_oevkov_2019.auswertung_gesamtauswertung
...
-- Tabelle avt_oevkov_2019.auswertung_gemeinde_einwohner_kosten
...
UPDATE
     avt_oevkov_2019.auswertung_gemeinde_einwohner_kosten AS kosten
SET
...
-- 	         wenn Korrekturen gemacht wruden
        ...
        FROM
	    avt_oevkov_2019.sachdaten_haltestelle_anrechnung AS anrechnung
	   LEFT JOIN avt_oevkov_2019.auswertung_auswertung_gtfs AS auswertung
	       ON auswertung.haltestellenname = anrechnung.haltestellenname
	  LEFT JOIN avt_oevkov_2019.auswertung_abfahrten_korrigiert AS korrektur
        ...
        SELECT
            ...
            korrektur.abfahrten_korrigiert
        FROM
            avt_oevkov_2019.auswertung_abfahrten_korrigiert AS korrektur
	        LEFT JOIN    avt_oevkov_2019.sachdaten_haltestelle_anrechnung AS anrechnung
                ON  korrektur.haltestellenname = anrechnung.haltestellenname
        WHERE
...
UPDATE
    avt_oevkov_2019.auswertung_gemeinde_einwohner_kosten AS gemeindekosten
SET
    kosten_minus_schwellenwert = schwellenwert  *  einwohnerzahl
FROM
      avt_oevkov_2019.sachdaten_oevkov_daten AS grunddaten
