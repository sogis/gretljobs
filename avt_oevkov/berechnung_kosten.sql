-- Tabelle avt_oevkov_${currentYear}_v1.sachdaten_oevkov_daten 
...
UPDATE
     avt_oevkov_${currentYear}_v1.auswertung_gemeinde_einwohner_kosten AS kosten
SET
...
FROM
    ...
    FROM
         avt_oevkov_${currentYear}_v1.auswertung_gesamtauswertung AS auswertung
    GROUP BY
        gemeindename
