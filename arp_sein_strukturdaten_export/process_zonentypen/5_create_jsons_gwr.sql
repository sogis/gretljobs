...
DROP TABLE IF EXISTS
    export.zonentyp_gwr_json CASCADE
;

CREATE TABLE
    export.zonentyp_gwr_json AS
    ...
    FROM
        export.zonentyp_geoms p
        LEFT JOIN gkat_json USING (typ_kt, bfs_nr)
        LEFT JOIN gklas_10_json USING (typ_kt, bfs_nr)
        LEFT JOIN gbaup_json USING (typ_kt, bfs_nr)
        LEFT JOIN wazim_json USING (typ_kt, bfs_nr)
;

CREATE INDEX
    ON export.zonentyp_gwr_json (typ_kt, bfs_nr)
;