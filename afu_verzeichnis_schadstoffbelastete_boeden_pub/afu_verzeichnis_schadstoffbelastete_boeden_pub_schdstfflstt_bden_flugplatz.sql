WITH dokumente AS (
    ...
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_dokument_flugplatz
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_flugplatz
    ...
    SELECT
        ...
        schdstfflstt_bden_flugplatz.t_id AS flugplatz
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_schadstoff_flugplatz
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_flugplatz
    ...
    FROM
        ...
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_flugplatz
    WHERE
