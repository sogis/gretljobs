WITH dokumente AS (
    ...
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_dokument_militaerischer_schiessplatz
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_militaerischer_schiessplatz
    ...
    SELECT
        ...
        schdstfflstt_bden_militaerischer_schiessplatz.t_id AS militaerischer_schiessplatz
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_schadstoff_militaerischer_schiessplatz
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_militaerischer_schiessplatz
    ...
    FROM
        ...
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_militaerischer_schiessplatz
    WHERE
