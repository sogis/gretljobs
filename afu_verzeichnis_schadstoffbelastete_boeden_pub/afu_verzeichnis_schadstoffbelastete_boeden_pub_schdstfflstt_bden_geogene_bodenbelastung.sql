WITH dokumente AS (
    ...
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_dokument_geogene_bodenbelastung
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_geogene_bodenbelastung
    ...
    SELECT
        ...
        schdstfflstt_bden_geogene_bodenbelastung.t_id AS geogene_bodenbelastung
    FROM
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_schadstoff_geogene_bodenbelastung
        LEFT JOIN afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_geogene_bodenbelastung
    ...
    FROM
        ...
        afu_verzeichnis_schadstoffbelastete_boeden.schdstfflstt_bden_geogene_bodenbelastung
    WHERE
