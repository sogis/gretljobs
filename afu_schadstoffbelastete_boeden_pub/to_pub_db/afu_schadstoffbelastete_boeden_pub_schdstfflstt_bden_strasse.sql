...
SELECT
	...
	ROUND(St_Area(schdstfflstt_bden_strasse.geometrie))::integer AS flaeche,
	ROUND(St_Perimeter(schdstfflstt_bden_strasse.geometrie))::integer AS umfang,
	...
	CASE
		WHEN schdstfflstt_bden_strasse.aktiv IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS aktiv_txt,
	CASE
		WHEN schdstfflstt_bden_strasse.nutzungseinschraenkung IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS nutzungseinschraenkung_txt,
	CASE
		WHEN schdstfflstt_bden_strasse.nutzungsverbot IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
