...
dokumente AS (
	...
	FROM
		...
		LEFT JOIN afu_schadstoffbelastete_boeden_v1.schdstfflstt_bden_geogene_bodenbelastung
...
SELECT
	...
	-- Boolean Txt-Attributes --
	CASE
		WHEN schdstfflstt_bden_geogene_bodenbelastung.aktiv IS TRUE
			THEN 'Ja'
		ELSE 'Nein'
	END AS aktiv_txt,
	CASE
		WHEN schdstfflstt_bden_geogene_bodenbelastung.nutzungseinschraenkung IS TRUE
			THEN 'Ja'
		ELSE 'Nein'
	END AS nutzungseinschraenkung_txt,
	CASE
		WHEN schdstfflstt_bden_geogene_bodenbelastung.nutzungsverbot IS TRUE
			THEN 'Ja'
		ELSE 'Nein'
