...
INSERT INTO
  ${DB_Schema_QRcat}.qrcat_fwert
     ...
     VALUES(99, uuid_generate_v4(), 0, 'dummy');
...
INSERT INTO
  ${DB_Schema_QRcat}.qrcat_toxreferenzszenario
     ...
     VALUES(99, uuid_generate_v4(), 'dummy', 'fluessig', 0, 0, 0, 0, 0);
...
INSERT INTO
  ${DB_Schema_QRcat}.qrcat_detailszenario_grundhaeufigkeit
    ...
    VALUES(99, uuid_generate_v4(), 'dummy', 'Brand', 'lb', 'lb_ft4', 0.000001, 'pro_Jahr', false, false, false);
