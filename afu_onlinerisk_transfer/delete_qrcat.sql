...
DELETE FROM ${DB_Schema_QRcat}.qrcat_toxreferenzszenario_typstoff;
DELETE FROM ${DB_Schema_QRcat}.qrcat_wk_grundhaeufigkeit_art;
DELETE FROM ${DB_Schema_QRcat}.qrcat_bevoelkerung_typ;
DELETE FROM ${DB_Schema_QRcat}.qrcat_letalitaetsradius_art;
DELETE FROM ${DB_Schema_QRcat}.qrcat_szenario_art;
