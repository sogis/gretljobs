...
WITH geometrie AS (
    ...
    FROM
        agi_swissboundaries3d_v1.tlm_bezirksgebiet
        LEFT JOIN
            agi_swissboundaries3d_v1.tlm_kantonsgebiet kanton
            ON
                kanton.kantonsnummer = tlm_bezirksgebiet.kantonsnummer
        LEFT JOIN
            agi_swissboundaries3d_v1.tlm_landesgebiet land
            ON
...
FROM
    geometrie
    LEFT JOIN 
        agi_swissboundaries3d_v1.tlm_bezirksgebiet bezirk
        ON
