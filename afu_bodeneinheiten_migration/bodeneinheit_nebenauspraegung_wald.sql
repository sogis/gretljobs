TRUNCATE afu_bodeneinheiten_v1.nebenauspraegung_wald CASCADE;
...
INSERT INTO afu_bodeneinheiten_v1.nebenauspraegung_wald (
    t_basket, 
    t_datasetname,
    import_oid,
    gewichtung,
...
SELECT
    ...
    CASE 
      ...
      WHEN imp.skelett_ob = 2 THEN 'skeletthaltig'
      WHEN imp.skelett_ob = 4 THEN 'stark_skeletthaltig'
      WHEN imp.skelett_ob = 6 THEN 'skelettreich'
...
LEFT JOIN 
    ...
    ON 
    imp.gemnr = hauptauspraegung.gemeinde_nr  
    AND 
    imp.objnr = hauptauspraegung.bodeneinheit_nummer
WHERE 
    imp.ist_hauptauspraegung = 'false'
    AND 
    imp.ist_wald = 'true' 
; 