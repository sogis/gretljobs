TRUNCATE afu_bodeneinheiten_v1.untertyp_p_nebenlandwirtschaft;
...
untertypen AS (
    ...
    LEFT JOIN 
        afu_bodeneinheiten_v1.nebenauspraegung_landwirtschaft bodeneinheit
        ON 
...
INSERT INTO 
    afu_bodeneinheiten_v1.untertyp_p_nebenlandwirtschaft (
        t_basket, 
        t_datasetname,
        nebenauspraegunglandassociation_p, 
        acode
    )
SELECT  
    basket.t_id,
