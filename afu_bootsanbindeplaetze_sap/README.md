...
Unterschieden wird zwischen einer Nutzungsgebühr und einer Bewilligungsgebühr. Die Nutzungsgebühr ist jedes Jahr fällig und wird auch jedes Jahr zum ungfähr gleichen Zeitpunkt für das aktuelle Jahr verrechnet. Die Bewilligungsgebühr wird einmalig bei der Bootsplatzbewilligung erhoben. Um diese mit der Nutzungsgebühr zu bündeln, wird hier auf das Bewilligungsdatum geachtet. 

Im Normalfall werden die Rechnungen gegen Ende März jeden Jahres für das aktuelle Jahr generiert. Wenn die Bewilligung nach dem 1.7. des letzten Jahres erhoben wurde, dann wird sie in die aktuelle Rechnungsperiode integriert, andernfalls nicht. Der Grund liegt darin, dass der Bootsanbindeplatzmieter ab Bewilligung ein halbes Jahr Zeit hat sein Boot zu platzieren. Dies ist im Grunde eine "Schonfrist". Hatte der Mieter im letzten Jahr noch mehr als ein halbes Jahr Zeit (Bewilligung wurde vor dem 1.7. ausgestellt), dann war sie Teil der vorjährigen Rechnungsperiode. Sofern die Bewilligung vor dem 1.7. aber nach der Rechnungsstellung (ca. Ende März) erteilt wurde, wird sie individuell gehandhabt.
