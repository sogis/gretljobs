...
LEFT JOIN awjf_waldplan_v2.waldplankatalog_forstbetrieb AS fb 
	ON  (
		...
		OR (w.fid_eigcod IN (44,46,435,440,441,719) AND fb.aname = 'Am Blauen')
		OR (w.fid_eigcod IN (14,17,408,410,411,414,720) AND fb.aname = 'Forst Dünnerntal')
		...
		OR (w.fid_eigcod = 96 AND fb.aname = 'Eppenberg-Wöschnau')
