...
CREATE TABLE 
    alw_fruchtfolgeflaechen.fruchtfolgeflaechen_buffer_mm AS 
...
CREATE TABLE alw_fruchtfolgeflaechen.fruchtfolgeflaechen_exteriorring AS 
...
CREATE TABLE alw_fruchtfolgeflaechen.fruchtfolgeflaechen_union AS
...
CREATE TABLE alw_fruchtfolgeflaechen.polys AS
...
CREATE TABLE alw_fruchtfolgeflaechen.polys_point AS
    SELECT 
	geom,
...
CREATE TABLE alw_fruchtfolgeflaechen.polys_attr AS
    ...
    INNER JOIN 
        alw_fruchtfolgeflaechen.polys_point AS polys 
	ON 
        ST_Intersects(polys.point, fff.geometrie)
;
...
CREATE TABLE alw_fruchtfolgeflaechen.polys_join AS
