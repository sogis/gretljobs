...
DROP SCHEMA if exists afu_isboden_pub CASCADE;
DROP SCHEMA if exists agi_hoheitsgrenzen_pub CASCADE;
DROP SCHEMA if exists alw_fff_uebersteuerung CASCADE;
DROP SCHEMA if exists alw_fruchtfolgeflaechen CASCADE;
DROP SCHEMA if exists alw_fruchtfolgeflaechen_alt CASCADE;
DROP SCHEMA if exists alw_gewaesserraum CASCADE;