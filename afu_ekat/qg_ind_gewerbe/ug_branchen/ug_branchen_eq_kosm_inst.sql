 SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
        CASE
         ...
         WHERE d.equelle_id = 123 AND e.s_code = 22 AND d.archive = 0 AND e.archive = 0)) * f.anz_arbpl::numeric)::double precision
   ...
   LEFT JOIN ( SELECT bz_noga_art_ha.anz_arbpl, bz_noga_art_ha.xkoord, 
            ...
            substr(bz_noga_art_ha.noga_art, 1, 2) AS substr
