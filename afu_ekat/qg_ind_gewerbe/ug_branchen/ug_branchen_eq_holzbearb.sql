SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
        CASE
         ...
         WHERE d.equelle_id = 184 AND e.s_code = 7 AND d.archive = 0 AND e.archive = 0)) * f.b15btot::numeric)::double precision
   ...
   LEFT JOIN ( SELECT vz15_minus_sammel_ha.b15btot, 
           ...
           FROM geostat.vz15_minus_sammel_ha) f ON a.xkoord = f.x_koord::numeric AND a.ykoord = f.y_koord::numeric
  WHERE a.archive = 0
