 SELECT a.gmde, a.wkb_geometry, b.emiss_co, b.emiss_co2, b.emiss_nox, 
    b.emiss_so2, b.emiss_nmvoc, b.emiss_ch4, b.emiss_pm10, b.emiss_nh3, 
    b.emiss_n2o, b.emiss_xkw
   FROM ekat2015.gmde_geom a, 
    ( SELECT d.gem_bfs, sum(d.emiss_co) AS emiss_co, sum(d.emiss_co2) AS emiss_co2, 
            ...
            sum(d.emiss_n2o) AS emiss_n2o, sum(d.emiss_xkw) AS emiss_xkw
           FROM ekat2015.ug_uplus_gesamt d
