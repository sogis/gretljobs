...
(SELECT min(a.ogc_fid) AS ogc_fid, min(a.xkoord) AS xkoord, 
    ...
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Kohlenmonoxid' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_co, 
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Kohlendioxid' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_co2,
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Stickoxide NOx, angegeben als NO2' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_nox,
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Schwefeldioxid' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_so2,
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Nichtmethan-Kohlenwasserstoffe, Lösemittel' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_nmvoc,
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Methan' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_ch4, 
    concat((select sum(emifrachtmsggf) from ekat2015.uplus where emidsotyps = 'Feinstaub < 10 Mikrometer' and emibetid = 1813 and anldatid <> 324)/(SELECT count(*) FROM ekat2015.ha_raster_100 WHERE ST_Intersects(wkb_geometry,(SELECT wkb_geometry FROM ekat2015.stahlwerk_gerlafingen))),0)::numeric as emiss_pm10,
    0 as emiss_nh3, 
    0 as emiss_n2o,
    0 as emiss_xkw
