 SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
        CASE
         ...
         WHERE d.equelle_id = 124 AND e.s_code = 22 AND d.archive = 0 AND e.archive = 0)) / b.besch_gesamt::double precision * f.besch_gesamt::numeric::double precision * 1000::double precision
