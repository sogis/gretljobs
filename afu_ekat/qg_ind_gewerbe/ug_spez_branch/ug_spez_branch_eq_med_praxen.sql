 SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
        CASE
         ...
         WHERE d.equelle_id = 121 AND e.s_code = 22 AND d.archive = 0 AND e.archive = 0)) * f.anz_arbpl::numeric)::double precision
   ...
   LEFT JOIN ( SELECT sum(bz_noga_art_ha.anz_arbpl) AS anz_arbpl, 
          ...
          WHERE bz_noga_art_ha.noga_art = ANY (ARRAY['862100'::text, '862200'::text, '862300'::text, '750000'::text])
