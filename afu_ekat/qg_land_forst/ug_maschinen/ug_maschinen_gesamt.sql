 SELECT d.ogc_fid, d.xkoord, d.ykoord, d.wkb_geometry, d.gem_bfs, 
    ...
    d.emiss_co2 + e.emiss_co2 AS emiss_co2, 
   ...
   FROM ekat2015.ug_maschinen_eq_maschlw d
   LEFT JOIN ekat2015.ug_maschinen_eq_maschfw e ON d.xkoord = e.xkoord AND d.ykoord = e.ykoord
