 SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 5 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
        ...
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 25 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_co2, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 2 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_nox, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 1 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_so2, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 26 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_n2o, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 7 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_pm10, 
        CASE
            WHEN c.g15e05 > 0 THEN c.g15e05::double precision * ((d.anteil_feuer_gas_juenger93 / 100::numeric * (d.anteil_feuer_gas / 100::numeric))::double precision * d.energieverbr * (( SELECT b.schast_efak
               FROM ekat2015.emiss_quelle a
          LEFT JOIN ekat2015.quelle_emiss_efak b ON a.equelle_id = b.equelle_id
         WHERE b.equelle_id = 68 AND b.s_code = 6 AND a.archive = 0 AND b.archive = 0))::double precision / f.sum_a00e05::double precision)
            ELSE 0::real::double precision
        END AS emiss_ch4
