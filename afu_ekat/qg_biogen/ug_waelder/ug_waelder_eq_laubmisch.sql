 SELECT c.ogc_fid, c.xkoord, c.ykoord, c.wkb_geometry, c.gem_bfs, 
        CASE
            WHEN d.waldart = 3 THEN (( SELECT round(((1::double precision * a.schast_efak::double precision + 2::double precision * b.schast_efak::double precision) / 3::double precision)::numeric, 2) AS schast_efak
