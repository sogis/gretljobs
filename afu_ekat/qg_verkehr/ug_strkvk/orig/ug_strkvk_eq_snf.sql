SELECT min(k.ogc_fid) AS ogc_fid, min(k.xkoord) AS xkoord, 
   ...
   FROM ( SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
            b.vsit, 
                CASE
                    WHEN b.neigung = 0 AND b.vsit::text = 'Agglo/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Agglo/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Agglo/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Agglo/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Agglo/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Agglo/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Agglo/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Agglo/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Agglo/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Agglo/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Agglo/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Agglo/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Agglo/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Agglo/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Agglo/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Agglo/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Agglo/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Agglo/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Agglo/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Agglo/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
