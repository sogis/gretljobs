   ...
   FROM ( SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
                CASE
                    WHEN a.xkoord = b.xkoord::numeric AND a.ykoord = b.ykoord::numeric THEN b.dtv2015_pw * (0.3333333 * ((( SELECT efak_kalt_tank.efak
                      ...
                      WHERE efak_kalt_tank.efak_code = 2 AND efak_kalt_tank.fhz_art = 'PKW'::text AND efak_kalt_tank.archive = 0))::numeric * d.anz_pw::numeric * 365::numeric) / 1000::numeric / c.dtv2015_pw_gem)
                    ELSE 0::numeric
                END AS emiss_nmvoc
