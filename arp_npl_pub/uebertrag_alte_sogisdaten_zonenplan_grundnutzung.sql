...
SELECT 
    ...
    CASE
      ...
      WHEN zcode = 131 THEN '130_Gewerbezone_mit_Wohnen'
      WHEN zcode = 141 THEN '142_Zentrumszone'
      WHEN zcode = 151 THEN '151_Zone_fuer_oeffentliche_Bauten'
      WHEN zcode = 152 THEN '152_Zone_fuer_oeffentliche_Anlagen'
      ...
      WHEN zcode = 912 THEN '169_Schrebergartenzone'
    END AS typ_kt,
    (CASE
      ...
      WHEN zcode = 141 THEN '142'
      WHEN zcode = 151 THEN '151'
      WHEN zcode = 152 THEN '152'
