...
SELECT
    ...
    substr(string_agg(gentyp.dispname,', '),1,30) AS genossenschaft_typ,
    --TODO: genossenschaft_name verlängern im Modell
    substr(string_agg(genoss.aname,', '),1,100) AS genossenschaft_name,
