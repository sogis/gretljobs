DELETE FROM arp_npl_mgdm.laermmp95_v1_1rechtsvorschrften_hinweisweiteredokumente;

INSERT INTO arp_npl_mgdm.laermmp95_v1_1rechtsvorschrften_hinweisweiteredokumente(
    ursprung,
    hinweis
)
...
FROM
    ...
    RIGHT JOIN arp_npl_mgdm.laermmp95_v1_1rechtsvorschrften_dokument AS dokument_ch
        ON 
