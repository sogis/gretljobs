...
Die CSV-Liste des MFK kann mit dem GRETL-Job in Jenkins eingelesen werden. Die Daten aus dem CSV-File, sowie die AfU-Daten werden dann in DuckDB miteinander verglichen. Exportiert wird anschliessend eine gpkg-Datei, auf welche QGIS zugreifen kann. Dafür wurde in QGIS bereits die entsprechende Symbolisierung erstellt. Die GPKG-Datei muss dafür immer mit dem gleichen Namen im gleichen Ordner abgelegt werden. Das AfU diesbezüglich selbst eine [Anleitung](https://github.com/sogis/dok/tree/dok/dok_rote_faeden/Documents/AFU/Bootsanbindeplaetze/Anleitungen_AfU) erstellt.
