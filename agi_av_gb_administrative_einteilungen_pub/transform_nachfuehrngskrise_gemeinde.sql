SELECT
  ...
  standort.auid
FROM
  agi_av_gb_administrative_einteilungen_v2.nachfuehrngskrise_gemeinde AS gemeinde
  LEFT JOIN agi_av_gb_administrative_einteilungen_v2.nachfuehrngskrise_nachfuehrungsgeometer AS geometer
