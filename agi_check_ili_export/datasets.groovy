...
datasets.add(new Dataset("SO_AFU_Hydro_Messstationen_20220706", "afu_hydro_messstationen_v1", dbEdit, "ch.so.afu.hydro_messstationen_edit"))
...
datasets.add(new Dataset("SO_AFU_Abwasserbauwerke_Publikation_20220323", "afu_abwasserbauwerke_pub_v1", dbPub, "ch.so.afu.abwasserbauwerke")) 
...
datasets.add(new Dataset("SO_AFU_Fischwanderhindernisse_Publikation_20220630", "afu_fischwanderhindernisse_pub_v1", dbPub, "ch.so.afu.fischwanderhindernisse")) 
...
datasets.add(new Dataset("SO_AFU_Gewaesser_Gewaessereigenschaften_Publikation_20220427", "afu_gewaesser_gewaessereigenschaften_pub_v1", dbPub, "ch.so.afu.gewaesser_gewaessereigenschaften")) 
datasets.add(new Dataset("SO_AFU_Gewaesser_Oekomorphologie_Publikation_20220426", "afu_gewaesser_oekomorphologie_pub_v1", dbPub, "ch.so.afu.gewaesser_oekmorphologie")) 
datasets.add(new Dataset("SO_AFU_Gewaesser_Revitalisierung_20220629", "afu_gewaesser_revitalisierung_pub_v1", dbPub, "ch.so.afu.gewaesser_revitalisierung")) 
...
datasets.add(new Dataset("SO_AfU_Wasserbewirtschaftung_Publikation_20220202", "afu_wasserbewirtschaftung_pub_v1", dbPub, "ch.so.afu.wasserbewirtschaftung"))
...
datasets.add(new Dataset("SO_AGS_Religionsgemeinschaften_Publikation_20220427", "ags_religionsgemeinschaften_pub_v1", dbPub, "ch.so.ags.religionsgemeinschaften")) 
...
datasets.add(new Dataset("SO_ALW_Landwirtschaft_Tierhaltung_Publikation_restricted_20211019", "alw_landwirtschaft_tierhaltung_pub_v1", dbPub, "ch.so.alw.landwirtschaft_tierhaltung")) 
...
datasets.add(new Dataset("SO_ARP_Naturschutzobjekte_Publikation_20210727", "arp_naturschutzobjekte_pub_v1", dbPub, "ch.so.arp.naturschutzobjekte")) 
datasets.add(new Dataset("SO_ARP_Nutzungsplanung_Publikation_20201005", "arp_nutzungsplanung_pub_v1", dbPub, "ch.so.arp.nutzungsplanung")) 
...
datasets.add(new Dataset("SO_ARP_Richtplan_Publikation_20220630", "arp_richtplan_pub_v1", dbPub, "ch.so.arp.richtplan")) 
...
datasets.add(new Dataset("SO_AVT_Kunstbauten_Publikation_20220207", "avt_kunstbauten_pub_v1", dbPub, "ch.so.avt.kunstbauten")) 
...
datasets.add(new Dataset("SO_AVT_Oev_Gueteklassen_20220120", "avt_oev_gueteklassen_pub_v1", dbPub, "ch.so.avt.oev_gueteklassen")) 
...
datasets.add(new Dataset("SO_AWJF_Naturgefahrenhinweiskarte_Publikation_20220125", "awjf_naturgefahrenhinweiskarte_pub_v1", dbPub, "ch.so.awjf.naturgefahrenhinweiskarte")) 
...
datasets.add(new Dataset("SO_AWJF_Statische_Waldgrenzen_Publikation_20191119", "awjf_statische_waldgrenze_pub_v1", dbPub, "ch.so.awjf.statische_waldgrenzen")) 
...
datasets.add(new Dataset("SO_AWJF_Waldstandorte_Publikation_20211027", "awjf_waldstandorte_pub_v1", dbPub, "ch.so.awjf.waldstandorte")) 
...
datasets.add(new Dataset("SO_AWJF_Wildtierkorridore_20210831", "awjf_wildtierkorridore_pub_v1", dbPub, "ch.so.awjf.wildtierkorridore")) 
