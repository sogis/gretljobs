...
// datasets.add(new Dataset("SO_AFU_ABBAUSTELLEN_Publikation_20210630", "afu_abbaustellen_pub_v1", dbPub, "ch.so.afu.abbaustellen", true)) 
...
// datasets.add(new Dataset("SO_AFU_Geotope_Publikation_20200623", "afu_geotope_pub", dbPub, "ch.so.afu.geotope", true)) 
...
// datasets.add(new Dataset("SO_AFU_Immissionskarten_20220522", "afu_immissionskarten_luft_pub_v1", dbPub, "ch.so.afu.immissionskarten_luft", true)) 
...
// datasets.add(new Dataset("SO_AFU_Stoerfallverordnung_Publikation_20220711", "afu_stoerfallverordnung_pub_v1", dbPub, "ch.so.afu.stoerfallverordnung", true)) 
...
// datasets.add(new Dataset("SO_AWJF_Programm_Biodiversitaet_Wald_Publikation_20220224", "awjf_programm_biodiversitaet_wald_pub_v1", dbPub, "ch.so.awjf.programm_biodiversitaet", true)) 
