...
DROP TABLE IF EXISTS 
    export.parzellen_basis CASCADE
;
...
CREATE INDEX
    ON export.parzellen_basis (t_ili_tid)
;

CREATE INDEX
    ON export.parzellen_basis (bfs_nr)
;

CREATE INDEX
    ON export.parzellen_basis (typ_kt)
;