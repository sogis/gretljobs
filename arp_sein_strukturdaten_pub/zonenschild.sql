...
create table export.zonenschild_dump (
	schild_uuid		uuid,
	typ_kt			text,
	typ_bund		text,
	bfs_nr			integer,
...
insert into export.zonenschild_dump
	select
...
create table export.zonenschild_basis (
	schild_uuid					uuid,
	geometrie					public.geometry(Polygon, 2056),
	typ_kt						text,
	typ_bund					text,
...
insert into export.zonenschild_basis
	select
		z.schild_uuid,
		z.geometrie,
	    z.typ_kt,
...
create table export.zonenschild_bodenbedeckung (
    schild_uuid		uuid,
    kategorie_text	text,
    flaeche_agg		numeric
);

insert into export.zonenschild_bodenbedeckung
	select
	    z.schild_uuid,
	    b.kategorie_text,
...
create table export.zonenschild_gwr_geb_agg (
    schild_uuid					uuid,
...
insert into export.zonenschild_gwr_geb_agg
    select
        schild_uuid,
...
create table export.zonenschild_gwr_wohn_agg (
    schild_uuid					uuid,
...
insert into export.zonenschild_gwr_wohn_agg
	select
		schild_uuid,
