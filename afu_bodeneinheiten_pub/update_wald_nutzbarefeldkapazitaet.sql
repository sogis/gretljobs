-- ============================================================================
-- Update nutzbare Feldkapazität für afu_bodeneinheiten_pub_v1.bodeneinheit_wald
-- ============================================================================
WITH
src AS (
    SELECT
    ...
    FROM afu_bodeneinheiten_pub_v1.bodeneinheit_wald b
    ...
    SELECT
        ...
        COALESCE(
            ...
            CASE s.skelett_ob
                ...
                WHEN 'skeletthaltig' THEN 2
                WHEN 'stark_skeletthaltig' THEN 4
                WHEN 'skelettreich' THEN 6
                WHEN 'kies' THEN 8
            END,
...
UPDATE 
    afu_bodeneinheiten_pub_v1.bodeneinheit_wald AS tgt
    SET
