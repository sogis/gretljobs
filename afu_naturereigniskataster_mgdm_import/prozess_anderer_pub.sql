SELECT
pr_a_andererprozess AS anderer_prozess,
...
FROM
    afu_naturereigniskataster_mgdm_v1.storme_mgdm_prozessraum_a AS prozessraum
    ...
    LEFT JOIN afu_naturereigniskataster_mgdm_v1.storme_mgdm_detailinformation_a AS detailinformation
      ON prozessraum.di_storme_mgdm_detailinformation_a = detailinformation.t_id
;
