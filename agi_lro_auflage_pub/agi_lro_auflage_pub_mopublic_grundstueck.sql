...
(
    SELECT
        ...
        pos
    FROM 
        agi_lro_auflage.liegenschaften_grundstueckpos
),
aimport AS
(
    SELECT
...
(
    SELECT
        ...
        pos.pos
    FROM
        agi_lro_auflage.liegenschaften_grundstueck AS grundstueck
        LEFT JOIN agi_lro_auflage.liegenschaften_liegenschaft AS liegenschaft
    ...
    FROM
        agi_lro_auflage.liegenschaften_grundstueck AS grundstueck
        LEFT JOIN agi_lro_auflage.liegenschaften_selbstrecht AS selbstrecht 
