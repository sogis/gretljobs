...
FROM
    av_avdpool_ng.bodenbedeckung_boflaeche AS bodenbedeckung
    LEFT JOIN av_avdpool_ng.bodenbedeckung_gebaeudenummer AS gebaeudenummer
        ON gebaeudenummer.gebaeudenummer_von = bodenbedeckung.tid
