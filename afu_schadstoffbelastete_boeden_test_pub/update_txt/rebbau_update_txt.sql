UPDATE afu_schadstoffbelastete_boeden_pub_v1.schdstfflstt_bden_rebbau AS rebbau
SET
	astatus_txt =  status.dispname
FROM
	afu_schadstoffbelastete_boeden_pub_v1.schadstoffbelasteter_boden_status AS status
WHERE 
	rebbau.astatus = status.ilicode
;
...
WHERE 
	rebbau.begruendung_aus_vsb_entlassen = begruendung.ilicode
;