UPDATE afu_schadstoffbelastete_boeden_pub_v1.schdstfflstt_bden_schrebergarten AS schrebergarten
SET
	astatus_txt =  status.dispname
FROM
	afu_schadstoffbelastete_boeden_pub_v1.schadstoffbelasteter_boden_status AS status
WHERE 
	schrebergarten.astatus = status.ilicode
;
...
WHERE 
	schrebergarten.begruendung_aus_vsb_entlassen = begruendung.ilicode
;