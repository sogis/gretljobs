...
SELECT
	...
	CASE
		WHEN schdstfflstt_bden_siedlungsgebiet.aktiv IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS aktiv_txt,
	CASE
		WHEN schdstfflstt_bden_siedlungsgebiet.nutzungseinschraenkung IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS nutzungseinschraenkung_txt,
	CASE
		WHEN schdstfflstt_bden_siedlungsgebiet.nutzungsverbot IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
