...
SELECT
	...
	ROUND(St_Area(schdstfflstt_bden_stahlbruecke.geometrie))::integer AS flaeche,
	ROUND(St_Perimeter(schdstfflstt_bden_stahlbruecke.geometrie))::integer AS umfang,
	...
	CASE
		WHEN schdstfflstt_bden_stahlbruecke.aktiv IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS aktiv_txt,
	CASE
		WHEN schdstfflstt_bden_stahlbruecke.nutzungseinschraenkung IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
	END AS nutzungseinschraenkung_txt,
	CASE
		WHEN schdstfflstt_bden_stahlbruecke.nutzungsverbot IS TRUE
			THEN 'Ja'
			ELSE 'Nein'
