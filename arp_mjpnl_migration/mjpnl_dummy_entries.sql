...
VALUES(
  ...
  4,
  'Dummy-Entry',
  (SELECT t_id FROM arp_mjpnl_v1.mjpnl_uzl_subregion LIMIT 1),
  'Dummy-Pfad',
  now()::date,
  'bjsvwneu',
  NULL,
...
INSERT INTO arp_mjpnl_v1.mjpnl_abrechnung_per_bewirtschafter
...
VALUES(9999999, 5, uuid_generate_v4(), (SELECT pid_gelan FROM arp_mjpnl_v1.betrbsdttrktrdten_gelan_person LIMIT 1), 'CH16090100565713403', 99, 'initialisiert', '1900-01-01', 1900, 'Dummy-Entry', 'Dummy-Pfad', now()::date, 'bjsvwneu', NULL, NULL);
...
VALUES(9999999, 5, uuid_generate_v4(), '01_DUMMY_00001', 'Dummy-Flurnamen', 'Dummy-Gemeinde', 99, 99, 1900, 'initialisiert', '1900-01-01', 'Dummy Entry', 9999999);
