...
-- Publizierte Gebiete
DROP TABLE IF EXISTS simpleThemePublicationCsv;
CREATE TEMP TABLE simpleThemePublicationCsv AS 
...
COPY simpleThemePublicationCsv TO '/tmp/simple_theme_publication_csv.csv' (HEADER false);
