...
LEFT JOIN 
    (SELECT  untertyp.profil, 
             json_build_array(json_build_object(
                 '@type', 'SO_AFU_Bodenprofilstandorte_Publikation_20200713.Bodenprofilstandorte.Untertyp',
...
LEFT JOIN 
    (SELECT 
        ...
        json_agg( 
            json_build_object(
                '@type', 'SO_AFU_Bodenprofilstandorte_Publikation_20200713.Bodenprofilstandorte.Horizont',
    ...
    LEFT JOIN 
        (SELECT 
            ...
            json_agg(
                json_build_object(
                    '@type', 'SO_AFU_Bodenprofilstandorte_Publikation_20200713.Bodenprofilstandorte.Gefuege',
    ...
    LEFT JOIN 
       (SELECT 
            ...
            json_agg(
                json_build_object(
                    '@type', 'SO_AFU_Bodenprofilstandorte_Publikation_20200713.Bodenprofilstandorte.Farbe',
